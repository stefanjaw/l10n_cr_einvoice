...
xmlns:d="https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/tiqueteElectronico"
    ...
    <html>
      <body>
        <table style="  border-collapse: collapse; width: 100%;">
          <tr>
            <td colspan="14" style="background-color: #3b9390;"><center><h1 style=" color: white;"><xsl:value-of select="d:TiqueteElectronico/d:Emisor/d:Nombre" /></h1></center></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="7"><span style='font-weight: bold;'>Tipo Identificacion: </span><xsl:value-of select="d:TiqueteElectronico/d:Emisor/d:Identificacion/d:Tipo"/></td>
            <td colspan="7"><span style='font-weight: bold;'>Tipo Identificacion: </span> <xsl:value-of select="d:TiqueteElectronico/d:Receptor/d:Identificacion/d:Tipo" /></td>
          </tr>
          <tr>
            <td colspan="7"><span style='font-weight: bold;'>Numero Identificacion: </span><xsl:value-of select="d:TiqueteElectronico/d:Emisor/d:Identificacion/d:Numero"/></td>
            <td colspan="7"><span style='font-weight: bold;'>Numero Identificacion: </span><xsl:value-of select="d:TiqueteElectronico/d:Receptor/d:Identificacion/d:Numero"/></td>
          </tr>
          <tr>
            <td colspan="7"><span style='font-weight: bold;'>Telefono: </span><xsl:value-of select="d:TiqueteElectronico/d:Emisor/d:Telefono/d:NumTelefono" /></td>
            <td colspan="7"><span style='font-weight: bold;'>Telefono: </span><xsl:value-of select="d:TiqueteElectronico/d:Receptor/d:Telefono/d:NumTelefono" /></td>
          </tr>
          <tr>
            <td colspan="7" style="padding-bottom: 6px;"><span style='font-weight: bold;'>Email: </span><xsl:value-of select="d:TiqueteElectronico/d:Emisor/d:CorreoElectronico"/></td>
          ...
          <xsl:for-each select="d:TiqueteElectronico/d:DetalleServicio/d:LineaDetalle">
            <tr>
         ...
         <tr>
           ...
           select="d:TiqueteElectronico/d:ResumenFactura/d:TotalVenta"/> 
           </td>
         </tr>
         <tr>
            <td colspan='12'></td>
         ...
         <tr>
            ...
            select="d:TiqueteElectronico/d:ResumenFactura/d:TotalImpuesto"/> 
            </td>
         </tr>
         <tr>
            <td colspan='12'></td>
            ...
            select="d:TiqueteElectronico/d:ResumenFactura/d:TotalComprobante"/> 
           </td>
         </tr>
        </table>
      </body>
