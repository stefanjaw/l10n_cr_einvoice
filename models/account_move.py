...
class AccountMove(models.Model):
    ...
    tax_condition = fields.Selection(
        ...
        selection= [
                ('01', '01-General Credito IVA'),
                ('02', '02-General Crédito parcial del IVA'),
                ('03', '03-Bienes de Capital'),
                ('04', '04-Gasto corriente no genera crédito'),
    ...
    fe_tipo_documento_referencia = fields.Selection(
        ...
        selection=[
                ('01','01-Factura electrónica'),
                ('02','02-Nota de débito electrónica'),
                ('03','03-Nota de crédito electrónica'),
                ('04','04-Tiquete electrónico'),
                ('05','05-Nota de despacho'),
                ('06','06-Contrato'),
                ('07','07-Procedimiento'),
                ('08','08-Comprobante emitido en contingencia'),
                ('09','09-Devolución mercadería'),
                ('10','10-Comprobante electrónico rechazado por el Ministerio de Hacienda'),
                ('11','11-Sustituye factura rechazada por el Receptor del comprobante'),
                ('12','12-Sustituye Factura de exportación'),
                ('13','13-Facturación mes vencido'),
    ...
    fe_condicion_impuesto = fields.Selection(
        ...
        selection=[
                ('01', '01-Genera crédito IVA'),
                ('02', '02-Genera Crédito parcial del IVA'),
                ('03', '03-Bienes de Capital'),
                ('04', '04-Gasto corriente no genera crédito'),
                ('05', '05-Proporcionalidad'),
        ],
    )
    ...
    fe_otros_ids = fields.One2many('account.move.otros.line','move_id')
