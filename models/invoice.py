...
class Invoice(models.Model):
    ...
    fe_informacion_referencia_fecha = fields.Datetime(string="Fecha de información de Referencia")
    ...
    def _cr_xml_mensaje_receptor(self):
        ...
        if 'FacturaElectronica' in bill_dic.keys():
            ...
            self.invoice = {self.fe_doc_type:{
                ...
                'NumeroCedulaReceptor':self.env.user.company_id.vat.replace('-','').replace(' ','') or None,#bill_dic['FacturaElectronica']['Receptor']['Identificacion']['Numero'],
